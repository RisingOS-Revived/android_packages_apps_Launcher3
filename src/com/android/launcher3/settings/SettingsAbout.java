...
public class SettingsAbout extends CollapsingToolbarBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            final Fragment f = fm.getFragmentFactory().instantiate(getClassLoader(),
                    getString(R.string.about_settings_fragment_name));
            f.setArguments(args);
    ...
    public boolean onPreferenceStartScreen(PreferenceFragmentCompat caller, PreferenceScreen pref) {
        ...
        return startPreference(getString(R.string.about_category_title), args, pref.getKey());
    }
     ...
     */
    public static class AboutSettingsFragment extends PreferenceFragmentCompat implements
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            AboutLayoutPreference aboutCardPreference = new AboutLayoutPreference(
                getContext(),
                R.layout.launcher_about_card
            );
            preferenceScreen.addPreference(aboutCardPreference);
